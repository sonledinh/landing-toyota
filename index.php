...
<main>
	<section class="box-banner pt-0">
		<div class="slide-banner">
			<div class="item"><img src="https://toyota-thaibinh.vn/wp-content/uploads/2021/03/summer-campaign.jpg" class="img-fluid w-100" alt=""></div>
		...
		<div class="container">
			...
			<div class="content-ab">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="avarta"><img src="https://toyota-thaibinh.vn/wp-content/uploads/2021/01/H2-2-1024x576.jpg" class="img-fluid w-100" alt=""></div>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-md-4 col-sm-6 wow fadeInLeft wHighlight" data-wow-delay=".25s">
						<div class="item-srv text-center">
							...
							<div class="info">
								...
								<div class="desc">
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, autem amet. Labore eos cum at, et illo ducimus.
								</div>
							</div>
						</div>
					</div>
				...
				<div class="item-slide text-center">
					<div class="item">
						...
						<div class="info"> 
							<h3>jhon stalker</h3>
							<h6>CEO</h6>
							<div class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At tempora cumque delectus nam obcaecati consectetur ad dolorum neque dolores nemo!</div>
						</div>
					</div>
				</div>
				<div class="item-slide text-center">
